        ...
        <>
            <section className="absolute top-0 w-screen h-screen bg-[#DCBA62] z-50 transform-gpu transition-transform duration-500 translate-x-[100em]" id='_sideBar' >
                <div className='flex flex-col w-screen h-screen  items-center'>
                    <section className='flex flex-row justify-around items-center gap-[7em] w-full min-h-[100px]'>
                        <>&nbsp;</>
                        <button onClick={() => document.getElementById("_sideBar").classList.add("translate-x-[100em]")}>
                            <svg
                    ...
                    <section className='flex flex-col w-screen h-full justify-around items-center font-Montserrat'>
                        ...
                        <ul className='text-center m-0 p-0 flex flex-row justify-around w-screen' >
                            <li><a href="https://www.facebook.com/"> <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li><a href="https://www.instagram.com/"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className='w-[30px] h-[30px]  hover:fill-current hover:text-[#8a3ab9]'>
                            ...
                            <li><a href="https://twitter.com/"><svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 310 310" version="1.1" viewBox="0 0 310 310" xmlSpace="preserve" className='w-[30px] h-[30px]  hover:fill-current hover:text-[#00acee]'>
                                <g>
