    ...
    <>
      <div className="min-h-fit w-screen font-Montserrat transform-cpu transition-all duration-100 overflow-hidden">
        ...
        <div className="flex flex-col justify-end items-center w-screen min-h-fit gap-10 pt-[8em] ">
          ...
          <span className="hidden md:block transform -rotate-90 absolute right-0 translate-x-[16em] -translate-y-[28em]  font-normal text-[14px] z-30">
          ...
          <section className="flex flex-col justify-center items-center z-30 gap-7 ">
            ...
            <a href="true" onClick={handleClick}>
              <svg
                ...
                xmlSpace="preserve"
                className="w-[30px] h-[30px] 2xl:w-[50px] 2xl:h-[50px] animate-bounce fill-[#000000]"
              >
